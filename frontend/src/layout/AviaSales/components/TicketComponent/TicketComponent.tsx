...
export const TicketComponent: FunctionComponent<TicketComponentProps> = props => {
    ...
    return <Container item={props.item} className={commonStyles.containerBottomMargin}>
        <div className={styles.container}>
            <Row className={commonStyles.rowReset}>
                ...
                <Col xs={6} sm={6} md={5} lg={4} lgOffset={4} mdOffset={2} className={cx(commonStyles.noPadding)}>
                    <img className={styles.logo} src={imgUrl} alt="ticket carrier"/>
                </Col>
            </Row>
            {
